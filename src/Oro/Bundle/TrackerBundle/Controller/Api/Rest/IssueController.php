...
namespace Oro\Bundle\TrackerBundle\Controller\Api\Rest;
...
class IssueController extends RestController implements ClassResourceInterface
{
     ...
     *      resource=true
     * )
     * @AclAncestor("orotracker_issue_update")
     * @return Response
     */
     ...
     *      resource=true
     * )
     * @AclAncestor("orotracker_issue_delete")
     *
     * @return Response
     */
    ...
    {
        return $this->get('orotracker_issue.manager.api');
    }
    ...
    {
        return $this->get('orotracker_issue.form.api');
    }
    ...
    {
        return $this->get('orotracker_issue.form.handler.issue_api');
    }
